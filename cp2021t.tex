...
\xymatrix@C=3.5cm{
  ...
  \ar[d]^-{\ensuremath{\ana{\Varid{clean}}}}
  & 
  \ensuremath{\Conid{X}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times(\Conid{ExpAr}\;\Conid{A})\;^2\mathbin{+}\Conid{UnOp}\times(\Conid{ExpAr}\;\Conid{A})))}
  \ar[u]_-{\ensuremath{\Varid{recExpAr}}}
  \\
  \ensuremath{\Conid{ExpAr}\;\Conid{B}} 
  \ar[d]^-{\ensuremath{\cata{\Varid{gopt}\;\Varid{a}}}}
  & 
  \ensuremath{\Conid{X}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times(\Conid{ExpAr}\;\Conid{B})\;^2\mathbin{+}\Conid{UnOp}\times(\Conid{ExpAr}\;\Conid{B})))}
  ...
  \ar[r]^-{\ensuremath{\Varid{outExpAr}}}
  & 
  \ensuremath{\Conid{X}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times\Conid{A}\;^2\mathbin{+}\Conid{UnOp}\times\Conid{A}))}
}
\end{eqnarray*}
...
\xymatrix@C=2.5cm{
  ...
  \\
  \ensuremath{(\Conid{ExpAr}\;\Conid{B},\N_0)} & \ensuremath{\mathrm{1}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times(\Conid{ExpAr}\;\Conid{B}\times\N_0)\;^2\mathbin{+}\Conid{UnOp}\times(\Conid{ExpAr}\;\Conid{B}\times\N_0)))}
  \ar[l]^-{\ensuremath{[\mskip1.5mu \Varid{g1},[\mskip1.5mu \Varid{g2},[\mskip1.5mu \Varid{g3},\Varid{g4}\mskip1.5mu]\mskip1.5mu]\mskip1.5mu]}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{mediaLTree}\;(\Conid{Fork}\;(\Varid{a},\Varid{b}))\mathrel{=}(\Varid{compLTree}\;\Varid{a}\mathbin{*}\Varid{mediaLTree}\;\Varid{a}\mathbin{+}\Varid{compLTree}\;\Varid{b}\mathbin{*}\Varid{mediaLTree}\;\Varid{b})\mathbin{/}(\Varid{compLTree}\;\Varid{a}\mathbin{+}\Varid{compLTree}\;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
