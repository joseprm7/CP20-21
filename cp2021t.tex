...
\\
\>[B]{}\ana{\Varid{g}}\mathrel{=}\Varid{inExpAr}\comp \Varid{recExpAr}\;\ana{\Varid{g}}\comp \Varid{g}{}\<[E]%
\\
\>[B]{}\Varid{hyloExpAr}\;\Varid{h}\;\Varid{g}\mathrel{=}\Varid{cataExpAr}\;\Varid{h}\comp \ana{\Varid{g}}{}\<[E]%
\\[\blanklineskip]%
...
\xymatrix@C=5.5cm{
  ...
  \ar@/_2pc/[r]_-{\ensuremath{\Varid{outExpAr}}}
  & 
  \ensuremath{\Conid{X}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times(\Conid{ExpAr}\;\Conid{A})\;^2\mathbin{+}\Conid{UnOp}\times(\Conid{ExpAr}\;\Conid{A})))}
  \ar@/_2pc/[l]_-{\ensuremath{\Varid{inExpAr}}}
}
\end{eqnarray*}
...
\xymatrix@C=3.5cm{
  \ensuremath{\Conid{X}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times(\Conid{ExpAr}\;\Conid{A})\;^2\mathbin{+}\Conid{UnOp}\times(\Conid{ExpAr}\;\Conid{A})))} 
  \ar[d]_-{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}\times\Varid{f}\;^2\mathbin{+}\Varid{id}\times\Varid{f}))}}
  \\ 
  \ensuremath{\Conid{X}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times\N_0\;^2\mathbin{+}\Conid{UnOp}\times\N_0))}
}
\end{eqnarray*}
...
\xymatrix@C=3.5cm{
  ...
  & 
  \ensuremath{\mathrm{1}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times(\Conid{ExpAr}\;\Conid{A})\;^2\mathbin{+}\Conid{UnOp}\times(\Conid{ExpAr}\;\Conid{A})))}
  \ar[d]^-{\ensuremath{\Varid{recExpAr}}}
  \\
  \ensuremath{\Conid{B}} & \ensuremath{\mathrm{1}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times\Conid{B}\;^2\mathbin{+}\Conid{UnOp}\times\Conid{B}))}
  \ar[l]^-{\ensuremath{[\mskip1.5mu \underline{\Varid{a}},[\mskip1.5mu \Varid{id},[\mskip1.5mu \Varid{g3},\Varid{g4}\mskip1.5mu]\mskip1.5mu]\mskip1.5mu]}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\mathrel{=}\alt{\underline{\Varid{a}}}{\alt{\Varid{id}}{\alt{\Varid{g3}}{\Varid{g4}}}}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mathbf{where}\;\Varid{g3}\;(\Conid{Product},(\Varid{c},\Varid{d}))\mathrel{=}{}\<[43]%
\>[43]{}\Varid{c}\mathbin{*}\Varid{d}{}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
\>[19]{}\Varid{g3}\;(\Conid{Sum},(\Varid{c},\Varid{d}))\mathrel{=}\Varid{c}\mathbin{+}\Varid{d}{}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
\>[19]{}\Varid{g4}\;(\Conid{Negate},\Varid{b})\mathrel{=}\mathbin{-}\Varid{b}{}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
\>[19]{}\Varid{g4}\;(\Conid{E},\Varid{b})\mathrel{=}\Varid{expd}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=3.5cm{
  \ensuremath{\Conid{ExpAr}\;\Conid{B}} 
  \ar[r]^-{\ensuremath{\Varid{outExpAr}}}
  & 
  \ensuremath{\mathrm{1}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times(\Conid{ExpAr}\;\Conid{B})\;^2\mathbin{+}\Conid{UnOp}\times(\Conid{ExpAr}\;\Conid{A})))}
  \\
  \ensuremath{\Conid{ExpAr}\;\Conid{A}} 
  \ar[u]^-{\ensuremath{\ana{\Varid{clean}}}}
  \ar[r]^-{\ensuremath{\Varid{clean}}}
  & 
  \ensuremath{\mathrm{1}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times\Conid{B}\;^2\mathbin{+}\Conid{UnOp}\times\Conid{B}))}
  \ar[u]_-{\ensuremath{\Varid{recExpAr}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{clean}\;(\Conid{N}\;\Varid{a})\mathrel{=}i_2\mathbin{\$}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{b})\mid \Varid{a}\equiv (\Conid{N}\;\mathrm{0})\mathrel{\vee}\Varid{b}\equiv (\Conid{N}\;\mathrm{0})\mathrel{=}i_2\mathbin{\$}i_1\;\mathrm{0}{}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mid \Varid{a}\equiv (\Conid{N}\;\mathrm{1})\mathrel{=}\Varid{clean}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mid \Varid{b}\equiv (\Conid{N}\;\mathrm{1})\mathrel{=}\Varid{clean}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mid \Varid{otherwise}\mathrel{=}i_2\mathbin{\$}i_2\mathbin{\$}i_1\;(\Conid{Product},(\Varid{a},\Varid{b})){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Sum}\;\Varid{a}\;\Varid{b})\mid \Varid{a}\equiv (\Conid{N}\;\mathrm{0})\mathrel{=}\Varid{clean}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mid \Varid{b}\equiv (\Conid{N}\;\mathrm{0})\mathrel{=}\Varid{clean}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mid \Varid{otherwise}\mathrel{=}i_2\mathbin{\$}i_2\mathbin{\$}i_1\;(\Conid{Sum},(\Varid{a},\Varid{b})){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Conid{Negate}\;(\Conid{N}\;\Varid{a}))\mathrel{=}{}\<[28]%
\>[28]{}i_2\mathbin{\$}i_1\;(\mathbin{-}\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Conid{E}\;(\Conid{N}\;\Varid{a}))\mathrel{=}i_2\mathbin{\$}i_1\;(\Varid{expd}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Varid{op}\;\Varid{a})\mathrel{=}i_2\mathbin{\$}i_2\mathbin{\$}i_2\;(\Varid{op},\Varid{a}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=3.5cm{
  ...
  & 
  \ensuremath{\mathrm{1}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times(\Conid{ExpAr}\;\Conid{A})\;^2\mathbin{+}\Conid{UnOp}\times(\Conid{ExpAr}\;\Conid{A})))}
  \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}\times\cata{\Varid{sd\char95 gen}}\mathbin{+}\Varid{id}\times\cata{\Varid{sd\char95 gen}}))}}
  \\
  \ensuremath{(\Conid{ExpAr}\;\Conid{B})\;^2} & \ensuremath{\mathrm{1}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times(\Conid{ExpAr}\;\Conid{B}\times\Conid{ExpAr}\;\Conid{B})\;^2\mathbin{+}\Conid{UnOp}\times(\Conid{ExpAr}\;\Conid{B})\;^2))}
  \ar[l]^-{\ensuremath{[\mskip1.5mu \Varid{g1},[\mskip1.5mu \Varid{g2},[\mskip1.5mu \Varid{g3},\Varid{g4}\mskip1.5mu]\mskip1.5mu]\mskip1.5mu]}}
}
\end{eqnarray*}
...
\\
\>[B]{}()+(\Varid{a}+((\Conid{BinOp},((\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a}),(\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a})))+(\Conid{UnOp},(\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a}))))\to (\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\alt{\Varid{g1}}{\alt{\Varid{g2}}{\alt{\Varid{g3}}{\Varid{g4}}}}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{g1}\;(){}\<[43]%
\>[43]{}\mathrel{=}(\Conid{X},\Conid{N}\;\mathrm{1.0}){}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{g2}\;\Varid{a}{}\<[43]%
\>[43]{}\mathrel{=}(\Conid{N}\;\Varid{a},\Conid{N}\;\mathrm{0.0}){}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{g3}\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))){}\<[43]%
\>[43]{}\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;\Varid{a}\;\Varid{c},\Conid{Bin}\;\Conid{Sum}\;\Varid{b}\;\Varid{d}){}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{g3}\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{c},\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{d})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{b}\;\Varid{c})){}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{g4}\;(\Conid{E},(\Varid{a},\Varid{b})){}\<[43]%
\>[43]{}\mathrel{=}(\Conid{Un}\;\Conid{E}\;\Varid{a},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{a})\;\Varid{b}){}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{g4}\;(\Conid{Negate},(\Varid{a},\Varid{b})){}\<[43]%
\>[43]{}\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;\Varid{a},\Conid{Un}\;\Conid{Negate}\;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2.5cm{
  \ensuremath{\Conid{ExpAr}\;\Conid{A}} 
  \ar[r]^-{\ensuremath{\Varid{outExpAr}}}
  \ar[d]_-{\ensuremath{\cata{\Varid{ad\char95 gen}\;\Varid{v}}}}
  & 
  \ensuremath{\mathrm{1}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times(\Conid{ExpAr}\;\Conid{A})\;^2\mathbin{+}\Conid{UnOp}\times(\Conid{ExpAr}\;\Conid{A})))}
  \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}\times\cata{\Varid{ad\char95 gen}\;\Varid{v}}\mathbin{+}\Varid{id}\times\cata{\Varid{ad\char95 gen}\;\Varid{v}}))}}
  \\
  \ensuremath{(\Conid{ExpAr}\;\Conid{B},\Conid{B})} & \ensuremath{\mathrm{1}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times(\Conid{ExpAr}\;\Conid{B}\times\Conid{B})\;^2\mathbin{+}\Conid{UnOp}\times(\Conid{ExpAr}\;\Conid{B}\times\Conid{B})))}
  \ar[l]^-{\ensuremath{[\mskip1.5mu \Varid{g1},[\mskip1.5mu \Varid{g2},[\mskip1.5mu \Varid{g3},\Varid{g4}\mskip1.5mu]\mskip1.5mu]\mskip1.5mu]}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ad\char95 gen}\;\Varid{v}\mathrel{=}\alt{\Varid{g1}}{\alt{\Varid{g2}}{\alt{\Varid{g3}}{\Varid{g4}}}}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{g1}\;(){}\<[45]%
\>[45]{}\mathrel{=}(\Varid{v},\mathrm{1.0}){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{g2}\;\Varid{a}{}\<[45]%
\>[45]{}\mathrel{=}(\Varid{a},\mathrm{0.0}){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{g3}\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))){}\<[45]%
\>[45]{}\mathrel{=}(\Varid{a}\mathbin{+}\Varid{c},\Varid{b}\mathbin{+}\Varid{d}){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{g3}\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{a}\mathbin{*}\Varid{c},\Varid{a}\mathbin{*}\Varid{d}\mathbin{+}\Varid{b}\mathbin{*}\Varid{c}){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{g4}\;(\Conid{E},(\Varid{a},\Varid{b})){}\<[45]%
\>[45]{}\mathrel{=}(\Varid{expd}\;\Varid{a},\Varid{expd}\;\Varid{a}\mathbin{*}\Varid{b}){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{g4}\;(\Conid{Negate},(\Varid{a},\Varid{b})){}\<[45]%
\>[45]{}\mathrel{=}(\mathbin{-}\Varid{a},\mathbin{-}\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{catalan}\;\Varid{n}\mathrel{=}(\mathrm{4}\mathbin{*}(\Varid{s}\;(\Varid{n}\mathbin{-}\mathrm{1}))\mathbin{-}\mathrm{2})\mathbin{*}(\Varid{catalan}\;(\Varid{n}\mathbin{-}\mathrm{1}))\div \mathrm{1}\mathbin{+}\Varid{s}\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{s}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{s}\;\Varid{n}\mathrel{=}\mathrm{1}\mathbin{+}\Varid{s}\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;(\Varid{c},\Varid{s})\mathrel{=}((\mathrm{4}\mathbin{*}\Varid{s}\mathbin{-}\mathrm{2})\mathbin{*}\Varid{c}\div \mathrm{1}\mathbin{+}\Varid{s},\mathrm{1}\mathbin{+}\Varid{s}){}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{comprimento}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{comprimento}\;(\Varid{a}\mathbin{:}\Varid{x})\mathrel{=}\mathrm{1}\mathbin{+}\Varid{comprimento}\;\Varid{x}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{media}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{media}\;(\Varid{a}\mathbin{:}\Varid{x})\mathrel{=}(\Varid{a}\mathbin{+}(\Varid{comprimento}\;\Varid{x})\mathbin{*}(\Varid{media}\;\Varid{x}))\mathbin{/}(\mathrm{1}\mathbin{+}\Varid{comprimento}\;\Varid{x}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{myCataList}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Varid{recList}\;(\Varid{myCataList}\;\Varid{g})\comp \Varid{outL}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{divide}\mathrel{=}\uncurry{(\mathbin{/})}{}\<[E]%
\\
\>[B]{}\Varid{multiplica}\mathrel{=}\uncurry{(\mathbin{*})}{}\<[E]%
\\
\>[B]{}\Varid{soma}\mathrel{=}\uncurry{(\mathbin{+})}{}\<[E]%
\\
\>[B]{}\Varid{suc}\mathrel{=}(\mathbin{+}\mathrm{1.0}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=3.5cm{
  \ensuremath{\Conid{Double}\mathbin{*}} 
  \ar[r]^-{\ensuremath{\Varid{outL}}}
  \ar[d]_-{\ensuremath{\cata{\Varid{avg\char95 aux}}}}
  & 
  \ensuremath{\Conid{Double}\mathbin{+}\Conid{Double}\times\Conid{Double}\mathbin{*}}
  \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\cata{\Varid{avg\char95 aux}}}}
  \\
  \ensuremath{(\Conid{Double},\Conid{Double})} & \ensuremath{\Conid{Double}\mathbin{+}\Conid{Double}\times(\Conid{Double},\Conid{Double})}
...
\column{15}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{myCataList}\;\alt{\Varid{b}}{\Varid{q}}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{b}\mathrel{=}\conj{\Varid{id}}{\underline{\mathrm{1.0}}}{}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{q}\mathrel{=}\conj{\Varid{divide}\comp \conj{\Varid{soma}\comp \conj{\Varid{multiplica}\comp \p2}{\p1}}{\Varid{suc}\comp \p2\comp \p2}}{\Varid{suc}\comp \p2\comp \p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{compLTree}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{compLTree}\;(\Conid{Fork}\;(\Varid{a},\Varid{b}))\mathrel{=}\Varid{compLTree}\;\Varid{a}\mathbin{+}\Varid{compLTree}\;\Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{mediaLTree}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{mediaLTree}\;(\Conid{Fork}\;(\Varid{a},\Varid{b}))\mathrel{=}(\Varid{compLTree}\;\Varid{a}\mathbin{*}\Varid{mediaLTree}\;\Varid{a}\mathbin{+}\Varid{compLTree}\;\Varid{b}\mathbin{*}\Varid{mediaLTree}\;\Varid{b})\mathbin{/}{}\<[E]%
\\
\>[B]{}\hsindent{27}{}\<[27]%
\>[27]{}(\Varid{compLTree}\;\Varid{a}\mathbin{+}\Varid{compLTree}\;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=3.5cm{
  ...
  \ar[r]^-{\ensuremath{\Varid{outExpAr}}}
  \ar[d]_-{\ensuremath{\cata{\Varid{avgLTree}}}}
  & 
  \ensuremath{\Conid{Double}\mathbin{+}(\mathsf{LTree}\;\Conid{Double})\;^2}
  \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\cata{\Varid{avgLTree}}\times\cata{\Varid{avgLTree}}}}
  \\
  \ensuremath{(\Conid{Double},\Conid{Double})} & \ensuremath{\Conid{Double}\mathbin{+}(\Conid{Double},\Conid{Double})\;^2}
  \ar[l]^-{\ensuremath{\Varid{avgLTree}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{gene}\mathrel{=}\alt{\conj{\Varid{id}}{\underline{\mathrm{1.0}}}}{\conj{\Varid{calc}}{\Varid{soma}\comp \Varid{getsnd}}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{calc}\mathrel{=}\Varid{divide}\comp \conj{\Varid{soma}\comp \conj{\Varid{multiplica}\comp \p1}{\Varid{multiplica}\comp \p2}}{\Varid{soma}\comp \Varid{getsnd}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{getsnd}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{b},\Varid{d}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
