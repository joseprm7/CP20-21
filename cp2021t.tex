...
\xymatrix@C=3.5cm{
  ...
  \\
  \ensuremath{\N_0} & \ensuremath{\Conid{X}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\times\N_0\;^2\mathbin{+}\Conid{UnOp}\times\N_0))}
...
\xymatrix@C=3.5cm{
  ...
  \ar[u]^-{\ensuremath{\cata{\Varid{gopt}\;\Varid{a}}}}
  & 
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  Funções definidas em pointwise:}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  catalan 0 = 1}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  catalan n = div ((4*(s (n-1))-2)*(catalan (n-1))) (1+ s (n-1))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  s 0 = 1}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  s n = 1 + s (n-1)}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{h}\mathrel{=}\bot \mbox{\commentbegin either g1 (inList . divide)
   g1 _ _ = nil 
   divide (x:xs) ys = (x,(xs,ys))
   inList (x,(xs,ys)) = x:xs:ys \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  talvez usar o x e o xs para calcular o Overtime?}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
\\
