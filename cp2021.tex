...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\commentbegin inExpAr = either (const X) num_ops where
  num_ops = either N ops
  ops     = either bin (uncurry Un)
  bin(op, (a, b)) = Bin op a b \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outExpAr}\;\Conid{X}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{N}\;\Varid{a})\mathrel{=}(i_2\comp i_1)\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{op}\;\Varid{a}\;\Varid{b})\mathrel{=}(i_2\comp i_2\comp i_1)\;(\Varid{op},(\Varid{a},\Varid{b})){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Un}\;\Varid{op}\;\Varid{a})\mathrel{=}(i_2\comp i_2\comp i_2)\;(\Varid{op},\Varid{a}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mathbf{where}\;\Varid{g3}\;(\Conid{Product},(\Varid{c},\Varid{d}))\mathrel{=}(\mathbin{*})\;\Varid{c}\;\Varid{d}{}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
\>[19]{}\Varid{g3}\;(\Conid{Sum},(\Varid{c},\Varid{d}))\mathrel{=}(\mathbin{+})\;\Varid{c}\;\Varid{d}{}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
